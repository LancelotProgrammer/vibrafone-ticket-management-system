...
class FrequentlyAskedQuestionPolicy
{
     ...
     * @return bool
     */
    public function view(User $user, FrequentlyAskedQuestion $frequentlyAskedQuestion): bool
    {
     ...
     * @return bool
     */
    public function update(User $user, FrequentlyAskedQuestion $frequentlyAskedQuestion): bool
    {
     ...
     * @return bool
     */
    public function delete(User $user, FrequentlyAskedQuestion $frequentlyAskedQuestion): bool
    {
     ...
     * @return bool
     */
    public function forceDelete(User $user, FrequentlyAskedQuestion $frequentlyAskedQuestion): bool
    {
     ...
     * @return bool
     */
    public function restore(User $user, FrequentlyAskedQuestion $frequentlyAskedQuestion): bool
    {
     ...
     * @return bool
     */
    public function replicate(User $user, FrequentlyAskedQuestion $frequentlyAskedQuestion): bool
    {
